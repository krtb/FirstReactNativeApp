...
class Themes extends Component {
    ...
    handlePressTheme = (color) => {
        // to emit the action that was just created, when a color is pressed in the theme section
        // passing color to this function, is important to know what color we're changing it to
